...
class Fuel(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("Fuel Calculator", "Fuel Calculator"))
        self.label_2.setText(_translate("MainWindow", "Fuel Level"))
        self.lblFuelLevel.setText(_translate("MainWindow", "14.94"))
        self.label_13.setText(_translate("MainWindow", "Laps in Race"))
        self.lblLaps.setText(_translate("MainWindow", "1"))
        self.label_4.setText(_translate("MainWindow", "Average"))
        self.lblAverage.setText(_translate("MainWindow", "1.52"))
        self.label_6.setText(_translate("MainWindow", "Laps Remaining"))
        self.lblRemaining.setText(_translate("MainWindow", "9.83"))
        self.label_9.setText(_translate("MainWindow", "Refuel"))
        self.lblRefuel.setText(_translate("MainWindow", "10.62"))
        self.label_11.setText(_translate("MainWindow", "Fuel at End"))
        self.lblFuelAtEnd.setText(_translate("MainWindow", "1.5"))
