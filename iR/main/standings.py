...
class Standings(object):
    def setupUi(self, MainWindow):
        ...
        iRData.reloadData()
        self.cargarDatosFijos()

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Standings"))
        self.lblSerie.setText(_translate("MainWindow", "AI Racing"))
    ...
    # Obtén los datos de la posición de los participantes comprobando en que sesion estamos
        ...
        tRestante = iRData.ir['SessionTimeRemain']
        ...
        if iRData.getSesionLaps(self) ==  'unlimited':
            ...
            self.lblVueltas.setText("Lap: " + str(iRData.lap) + "/" + str((vTotales)))
            estTotal = iRData.estLap * vTotales
            self.lblTiempo.setText(sesionName + str(tTranscurrido) + " / " + self.convertirTiempo(estTotal) + "~")
        #if sesion == 0:
         #   self.lblVueltas.setText("Lap: " + str(iRData.lap))
        #else:
         #   self.lblVueltas.setText("Lap: " + str(iRData.lap) + "/" + "{0:.2f}".format((vTotales)) )      
